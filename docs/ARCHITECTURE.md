...
- parses the selected Hestia log directly by default; if an administrator configures ignored paths, the add-on filters those paths before passing data to GoAccess
